...
pattern UpcastErrorE :: forall sup sub a b. 
  ( Upcast sup 
  , Upcast sub
  , SingI a
  , SingI b
...
pattern UpcastErrorE sup sub <- (sup,sub,Dict,Dict,Dict,Dict,Dict,Dict)
  where UpcastErrorE sup sub  = (sup,sub,Dict,Dict,Dict,Dict,Dict,Dict)
